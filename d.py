...
behaviors={
        ...
        "mobile device user": "all mobile devices by operating system",
        "digital activities": "all creators",
        "digital activitiesTeam": "music creators"
    }

demographics_str = str(demographics)
